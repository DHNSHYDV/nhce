        ...
        <div className="w-full max-w-5xl mx-auto py-12 px-6">
            <div className="text-center mb-20 space-y-6">
                <div className="flex items-center justify-center gap-3">
                    ...
                    <span className="text-[10px] font-black tracking-[0.5em] text-white/40 uppercase italic">Dynamic Trajectory</span>
                </div>
                ...
                <p className="text-white/20 text-[10px] uppercase tracking-[0.4em] max-w-xl mx-auto font-medium">
